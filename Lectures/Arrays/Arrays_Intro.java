...
// 1. this datataype represnts the what is the type of data stored inside the array 
...
public class Arrays_Intro{
    public static void main(String [] args){
        ...
        // ros = new int[5];// Initialisation here actual object is being creted in the heap memory
        // you have to mention the size otherwise it will give o an error 
